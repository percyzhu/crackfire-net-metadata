...
for folder, base, details in records:
    ...
    qa = {
        ...
        "source_generator_modified_in_actual_generation": False,
    ...
    md += ["", "The original generators and frozen source evidence were not modified. Final manuscript placement and manuscript expert review remain separate checks.", ""]
